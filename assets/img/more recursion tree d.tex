    ...
    \resizebox{\linewidth}{!}{%
        ...
        for tree={
          ...
          %l sep=15pt, % Adjust the horizontal separation
            ...
            \node (b) [right=of L2 -| empty32.east] {$3\sqrt{\frac{n}{3}}$};
            \node (c) [right=of empty32.east]       {$9\sqrt{\frac{n}{9}}$};
            ...
            \draw[->] (d.east) -- node[midway,fill=white] {$\ell=\log _{3} n$} (e.east);
            %draw breadth annotation
            \draw[decorate,decoration={brace,amplitude=10pt, mirror}]
            (g.south) -- node[below=10pt] {$T(n)=\sum_{i=0}^{\ell-1} 3^{i}\sqrt{\frac{n}{3^{i}}}$} (f.south);
            %etc. denotation
