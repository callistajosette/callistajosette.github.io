...
<div class="accordion">
  <div class="accordion-item">
    ...
    <label class="accordion-header" for="p5-4">+ $D(n)= 3D(n/3)+\sqrt{n}$</label>
    <div class="accordion-content">
      <p>
        <img src="/assets/img/more%20recursion%20trees%20d.png" alt="D(n)">       
      </p>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div class="accordion-content">
      <p>
        ...
        (\frac{4}{3})^{\ell} & \geq n \\          
        \log _{\frac{4}{3}}{(\frac{4}{3})}^{\ell} & \geq \log _{\frac{4}{3}} n \\
...
<iframe src="https://trinket.io/embed/python/9f4126f486?runOption=run" width="100%" height="250px" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
## Credits
