...
<object data="/proofs/recurrences_hanoi_general.pdf#toolbar=0&navpanes=0&scrollbar=0&statusbar=0&messages=0&scrollbar=0 " width="100%" height="calc(103% * (8.5 / 11))" type='application/pdf'></object>
